package com.rubemmartins.agenda;

import java.io.IOException;
import java.time.LocalDate;

import com.rubemmartins.agenda.gui.EditaPessoaController;
import com.rubemmartins.agenda.gui.PessoaController;
...
public class Main extends Application {
	...
	public Main() {
		dados.add(new Pessoa("Rubem", "Martins", LocalDate.of(1996, 11, 6)));
		dados.add(new Pessoa("Maria", "Madalena", LocalDate.of(1996, 11, 6)));
		dados.add(new Pessoa("Nelson", "Mandela", LocalDate.of(1918, 7, 18)));// 18 de julho de 1918
		dados.add(new Pessoa("Frida", "Kahlo", LocalDate.of(1907, 7, 06))); // 6 de julho de 1907
